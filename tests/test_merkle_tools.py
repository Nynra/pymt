...
class Test_proof(unittest.TestCase):
    ...
    def test_bad_proof(self):
        ...
        mt.make_tree()
        proof = mt.get_proof_of_inclusion(1)
        is_valid = mt.validate_proof_of_inclusion(proof, bRight, bLeft)
    ...
    def test_validate_5_leaves(self):
        ...
        is_valid = mt.validate_proof_of_inclusion(proof, 'badc3e7343f016890c510e93f935261169d9e3f565436429830faf0934f4f8e4', 
                        'd71f8983ad4ee170f8129f1ebcdd7440be7798d8e1c80420bf11f1eced610dba')
        self.assertFalse(is_valid)

        # good proof
        proof = mt.get_proof_of_inclusion(4)
        is_valid = mt.validate_proof_of_inclusion(proof, '3f79bb7b435b05321651daefd374cdc681dc06faa65e374e38337b88ca046dea', 
                        'd71f8983ad4ee170f8129f1ebcdd7440be7798d8e1c80420bf11f1eced610dba')
        self.assertTrue(is_valid)

        proof = mt.get_proof_of_inclusion(1)
        is_valid = mt.validate_proof_of_inclusion(proof, '3e23e8160039594a33894f6564e1b1348bbd7a0088d42c4acb73eeaed59c009d', 
                        'd71f8983ad4ee170f8129f1ebcdd7440be7798d8e1c80420bf11f1eced610dba')
        self.assertTrue(is_valid)
...
class Test_hash_functions(unittest.TestCase):
    ...
    def test_sha224(self):
        ...
        is_valid = mt.validate_proof_of_inclusion(mt.get_proof_of_inclusion(0), '90a3ed9e32b2aaf4c61c410eb925426119e1a9dc53d4286ade99a809', 
    ...
    def test_sha256(self):
        ...
        is_valid = mt.validate_proof_of_inclusion(mt.get_proof_of_inclusion(0), '1516f000de6cff5c8c63eef081ebcec2ad2fdcf7034db16045d024a90341e07d', 
    ...
    def test_sha384(self):
        ...
        is_valid = mt.validate_proof_of_inclusion(mt.get_proof_of_inclusion(0), '84ae8c6367d64899aef44a951edfa4833378b9e213f916c5eb8492cc37cb951c726e334dace7dbe4bb1dc80c1efe33d0', 
    ...
    def test_sha512(self):
        ...
        is_valid = mt.validate_proof_of_inclusion(mt.get_proof_of_inclusion(0), 'c0a8907588c1da716ce31cbef05da1a65986ec23afb75cd42327634dd53d754be6c00a22d6862a42be5f51187a8dff695c530a797f7704e4eb4b473a14ab416e', 
    ...
    def test_sha3_224(self):
        ...
        is_valid = mt.validate_proof_of_inclusion(mt.get_proof_of_inclusion(0), '6ed712b9472b671fd70bb950dc4ccfce197c92a7969f6bc2aa6b6d9f', 
    ...
    def test_sha3_256(self):
        ...
        is_valid = mt.validate_proof_of_inclusion(mt.get_proof_of_inclusion(0), '1d7d4ea1cc029ca460e486642830c284657ea0921235c46298b51f0ed1bb7bf7', 
    ...
    def test_sha3_384(self):
        ...
        is_valid = mt.validate_proof_of_inclusion(mt.get_proof_of_inclusion(0), 'e222605f939aa69b964a0a03d7075676bb3dbb40c3bd10b22f0adcb149434e7c1085c206f0e3371470a49817aa6d5b16', 
    ...
    def test_sha3_512(self):
        ...
        is_valid = mt.validate_proof_of_inclusion(mt.get_proof_of_inclusion(0), '004a237ea808cd9375ee9db9f85625948a890c54e2c30f736f54c969074eb56f0ff3d43dafb4b40d5d974acc1c2a68c046fa4d7c2c20cab6df956514040d0b8b', 
