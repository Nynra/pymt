...
class TestMerkleToolProof(unittest.TestCase):
...
class TestMerkleTree(ProofOfInclusion, unittest.TestCase):
    ...
    def test_build_tree_with_many_leaves(self):
        ...
        self.mt.make_tree()
        self.assertTrue(self.mt.is_ready)
        self.assertEqual(self.mt.get_merkle_root(), b'90a110224740a76b68e8c5a7980ac65e991620e1ce7e0d02cc586993599542bd')
